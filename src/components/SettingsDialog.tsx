        ...
        <div className="modal__body">
          ...
          <div className="field field--info">
            ...
            <span className="field__value">
              v{__APP_VERSION__} <span className="field__sub">({__BUILD_TIME__})</span>
            </span>
          </div>

          <div className="field field--info">
            <span className="field__label">이메일</span>
            <a className="field__value field__value--link" href="mailto:charliechoi1980@gmail.com">
              charliechoi1980@gmail.com
            </a>
          </div>
        </div>
